...
const SongItem: React.FC<SongItemProps> = ({data, onClick}) => {
    ...
    return ( 
        <div onClick={() => onClick(data.id)} className="relative group flexx flex-col items-center 
        rounded-md overflow-hidden gap-x-4 bg-neutral-400/5 cursor-pointer hover:bg-neutral-400/10 transition p-3">
            <div className="relative aspect-square w-full h-full rounded-md overflow-hidden">
                <Image className="object-cover" src={imagePath || "/images/light.png"} fill alt="image"/>
            </div>
